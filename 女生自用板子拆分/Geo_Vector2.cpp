...
namespace Geometry
{
	...
	struct Vector2
	{
		...
		/*向量圆形插值*/
		static Vector2 SlerpUnclamped(Vector2 a, Vector2 b, FLOAT_ t)
		{
			// Vector2 c = b - a;
		...
		static FLOAT_ ProjectLength(Vector2 vector, Vector2 onNormal)
		{
			return cos(Rad(vector, onNormal)) * vector.magnitude();
		}
	};
	struct PolarSortCmp
	{
